...
6. **Absolute paths everywhere:** All paths are absolute (`/Users/zaytsev/.openclaw/workspace/...`) to support running from any directory.
...
openclaw cron add \
  ...
  --schedule "0 3 * * *" \
  --command "python3 /Users/zaytsev/.openclaw/workspace/scripts/taskrunner/runner.py memory_consolidate"
```
...
```bash
# Run test suite
cd /Users/zaytsev/.openclaw/workspace/scripts/taskrunner
python3 test_all.py
