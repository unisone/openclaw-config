# Research Findings: Community-Validated Best Practices
...
## 🔴 Critical Corrections to Common Recommendations
...
**Naive/default approach**: Well-intentioned but some common recommendations are broken
**Community-validated**: Production-tested by real deployments
...
**Key lessons**: Avoid the broken ${VAR} pattern, always verify backup integrity, use correct LaunchAgent settings.

**Production readiness**: These community-validated practices align with real production deployments.
