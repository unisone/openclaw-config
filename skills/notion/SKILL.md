...
- ❌ Don't use for local-first plain markdown notes (prefer `obsidian`).
- ❌ Don't use for quick macOS capture (prefer `apple-notes`).
- ❌ Don't use for simple tagged notes/research (prefer `bear-notes`).
